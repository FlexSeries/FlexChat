...
public final class TownyNationChannel extends FileChannel {

    public TownyNationChannel(String shortName, ChatColor color, Collection<String> banned, Map<String, String> formats) {
        super("nation", shortName, color, banned, formats);
    }
